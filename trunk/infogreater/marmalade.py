...
# This file is taken from Twisted, http://twistedmatrix.com/. It was
# slightly modified.
...
def unjellyFromXML(stringOrFile):
    ...
    if hasattr(stringOrFile, "read"):
        ...
        document = parseXMLString(stringOrFile)
    return unjellyFromDOM(document)


from twisted.web.microdom import Text, Element, Node, Document, parse, parseXMLString, CDATASection, NodeList
